...
def test_segy_rev0(mock_segy_rev0, num_samples, num_traces) -> None:
    ...
    assert mock_segy_rev0.binary_header.at[0, "samples_per_trace"] == num_samples
...
def test_segy_rev1(mock_segy_rev1, num_samples, num_traces) -> None:
    ...
    assert mock_segy_rev1.binary_header.at[0, "samples_per_trace"] == num_samples
